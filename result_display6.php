        ...
        <?php array_push($array1, $checkans); } ?>
            ...
            <?php for ($x=0; $x <1; $x++) { ?>
                <form class="form-inline" method="post" action="<?php echo base_url('user/addscore');?>">
                  <div>
                    ...
                    <div><h1 style="font-family:arial; font-size:180%;"><?=$array3[$x]?>. <?=$array4[$x]?></p></div>
                      <br>
                        ...
                        <?php } else { ?>
                              ...
                              <div class="alert alert-success" style="height:350px;width:450px;"><strong> Well done!</strong> You answered it right.
          ...
          <?php 
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                      <button type="submit" name="action" value="saveScore" class="btn btn-primary btn-lg"> Save Score </button>
                    </div>
                </div>
            </form>
    </div>
